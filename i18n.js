(() => {
  const translations = {
    en: {
      ...
      hero: "Company analysis.<br><em>Long-term investing.</em>",
      intro: "I study Economics at EAFIT as an Ecopetrol Scholar and hold a technical qualification in Teleinformation Systems from SENA. I combine portfolio management at Cisneros Capital with economic research and technology applied to financial analysis.",
      ...
      years: ["Current", "2026 — Present", "2025", "2023 — Present", "Technical foundation"],
      journeyNames: ["Founder, CEO & CFO · Kaney AI & Software", "BSc Economics · Universidad EAFIT", "Academic & student leadership", "Self-directed investor", "Teleinformation Systems · SENA"],
      journeyCopy: [
        "I lead the company’s financial direction and strategic decisions while keeping the operation focused, lean and compatible with my academic development.",
        ...
        "Earned an Ecopetrol scholarship after ranking among Colombia’s top 100 State Exam scores and served as Student Representative at I.E. Técnico Cristo Rey.",
      ...
      journeyTags: ["Executive leadership", "Ecopetrol Scholar", "Leadership", "Equity research", "Technology"],
      ...
      certificationButtons: ["View certificate", "View certificate", "View certificate"],
    ...
    es: {
      ...
      hero: "Análisis de empresas.<br><em>Inversión a largo plazo.</em>",
      intro: "Soy estudiante de Economía en EAFIT, becario de Ecopetrol y técnico en Sistemas Teleinformáticos del SENA. Combino la gestión de carteras en Cisneros Capital con investigación económica y tecnología aplicada al análisis financiero.",
      ...
      years: ["Actualidad", "2026 — Presente", "2025", "2023 — Presente", "Base técnica"],
      journeyNames: ["Fundador, CEO y CFO · Kaney AI & Software", "Pregrado en Economía · Universidad EAFIT", "Liderazgo académico y estudiantil", "Inversionista autodidacta", "Sistemas Teleinformáticos · SENA"],
      journeyCopy: [
        "Dirijo la estrategia financiera y las decisiones de la empresa, manteniendo una operación pequeña, enfocada y compatible con mi formación académica.",
        ...
        "Obtuve una beca de Ecopetrol por estar entre los 100 mejores puntajes de la prueba de Estado en Colombia y ejercí como personero estudiantil en la I.E. Técnico Cristo Rey.",
      ...
      journeyTags: ["Liderazgo ejecutivo", "Becario Ecopetrol", "Liderazgo", "Análisis de acciones", "Tecnología"],
      ...
      certificationButtons: ["Ver certificado", "Ver certificado", "Ver certificado"],
